...
export interface ApiApiKeyApiKey extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    environment: Schema.Attribute.Enumeration<['test', 'live']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'test'>;
    keyHash: Schema.Attribute.String & Schema.Attribute.Unique;
    keyPrefix: Schema.Attribute.String;
    keyType: Schema.Attribute.Enumeration<['publishable', 'secret']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'publishable'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::api-key.api-key'
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    timedEvent: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiTimedEventTimedEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Timed Event';
    pluralName: 'timed-events';
    singularName: 'timed-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    enabled: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    endingSoonMinutes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiWebhookEndpointWebhookEndpoint
  extends Struct.CollectionTypeSchema {
  collectionName: 'webhook_endpoints';
  info: {
    displayName: 'Webhook Endpoint';
    pluralName: 'webhook-endpoints';
    singularName: 'webhook-endpoint';
  };
  options: {
    draftAndPublish: false;
  };
